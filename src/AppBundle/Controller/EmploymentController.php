...
class EmploymentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Employment')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Employment:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Employment')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Employment:edit.html.twig")
     */
